...
containerPort=$(docker inspect --format='{{(index (index .NetworkSettings.Ports "8080/tcp") 0).HostPort}}' "$CONTAINER_NAME")
...
echo "-------------------here is you container name and domain name-------------------------"


# Function to display container and domain in a table-like format
display_table() {
